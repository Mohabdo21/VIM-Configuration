return {
	...
	config = function()
		...
		vim.keymap.set("n", "<leader>fc", builtin.live_grep, { desc = "Find string in cwd" })
		...
		vim.keymap.set("n", "<leader>fm", builtin.git_commits, { desc = "Search Git Commits" })
		vim.keymap.set("n", "<leader>fu", builtin.git_bcommits, { desc = "Search Git Commits for Buffer" })
